...
int video_stream_start(VideoStream * stream, RtpProfile *profile, const char *remip, int remport, int payload, int jitt_comp, MSWebCam *device);
...
int video_stream_send_only_start(VideoStream * stream, RtpProfile *profile, const char *remip, int remport, int payload, int jitt_comp, MSWebCam *device);
